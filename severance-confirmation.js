(() => {
  ...
  const $=id=>document.getElementById(id),form=$("confirmationForm"),message=$("formMessage"),originalPageTitle=document.title;
  ...
  $("printPdf").addEventListener("click",()=>{document.title="資遣確認單"},{capture:true});
